...
#------------------------- Public Functions ----------------------------------------------
    ...
    function renderChartJS($chartSWF, $dataUrl, $dataStr, $chartId, $chartWidth, $chartHeight, $debugMode = false, $registerWithJS = true, $allowTransparent = false) {
        ...
        if ($debugMode)
            $this->FC_SetConfiguration("debugMode", $this->boolToNum($debugMode));
        ...
        if ($wmode != "")
            $this->FC_SetConfiguration("wmode", $wmode);
...
HTMLCHART;
    ...
    function FC_INITIALIZE() {
         ...
         * bgColor 			: set the flash player's background color. This gets shown up if the chart background alpha is set less than 100 and wmode is not transparent
        ...
        $this->FC_DEFAULT_CONFIG["params"]["renderer"] = "javascript";
        ...
        $this->FC_DEFAULT_CONFIG["params"]["registerWithJS"] = "1";
