...
!function( $ ) {
    ...
    Combobox.prototype = $.extend({}, $.fn.typeahead.Constructor.prototype, {
        ...
        toggle: function () {
            if (this.$container.hasClass('combobox-selected')) {
                ...
                $("#main_frame").hide();
                //      this.triggerChange()//comete by kiran
                this.clearElement()
            } else {
                if (this.shown) {
                    this.hide()
   ...
   * =========================== */
    ...
    $.fn.combobox.defaults = {
        template: '<div class="combobox-container"><input type="hidden" /><input type="text" id="brand_search_box" autocomplete="off" /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
        , 
